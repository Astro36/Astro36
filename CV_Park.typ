...
#tile(
  ...
  "2023.09 - 2023.12",
  [Big Data Training Hackathon: Food Image Classification Challenge, hosted by the #link("https://kbig.kr/")[K-ICT Big Data Center], and organized by the #link("https://www.msit.go.kr/")[MSIT#smaller[(Ministry of Science and ICT)]] and the #link("https://www.nia.or.kr/")[NIA#smaller[(National Information Society Agency)]]],
)
#tile(
