...
#let gray1 = white.darken(5%)
#let gray2 = white.darken(20%)

#set document(title: "Seungjae Park", author: "Seungjae Park")
#set page(numbering: "1", number-align: center)
#set text(font: "Pretendard", size: 11pt, fill: black2)
...
#align(center)[
  #block(
    below: 0pt,
    text(weight: "bold", size: 36pt, fill: black1)[= Portfolio],
  )
  #block(
    above: 18pt,
    text(weight: "bold", size: 24pt, fill: black1)[2019 - 2026],
  )
]
...
*CV*: #link("https://astro36.github.io/Astro36/CV_Park.pdf")[astro36.github.io/Astro36/CV_Park.pdf]

=== Certifications

#block(spacing: 1em)[
  *투자자산운용사*, 한국금융투자협회 #h(1fr) #text(size: 0.9em, fill: black3)[2024.06]
]
#block(spacing: 1em)[
  *정보처리기사*, 한국산업인력공단 #h(1fr) #text(size: 0.9em, fill: black3)[2024.06]
]
#block(spacing: 1em)[
  *리눅스마스터 2급*, 한국정보통신진흥협회 #h(1fr) #text(size: 0.9em, fill: black3)[2023.12]
]
...
#tile(
  ...
  [*성과)*],
  [SCIE Q1 저널 1편 게재, 국내 저널(KCI) 1편 게재, 국내 학회 1편 발표, SCIE/SSCI 저널 각각 1편 추가 제출 준비 중],

  [*기술)*],
  [Python, PyTorch, Financial AI, Large Language Model, Time Series Forecasting],
)
#tile(
  [
...
#tile(
  ...
  [*기술)*],
  [Kotlin, Android App, Python, Flask, Docker, MariaDB, Nginx],
)
#tile(
  [
  ...
  [*기술)*],
  [Java, Android App, Node.js, Express.js, Docker, MySQL, Nginx],
)
...
#tile(
  ...
  [*기술)*],
  [Java, #accent[Spring Boot], JavaScript, React, Docker, MySQL],
)
#tile(
  [
...
#tile(
  ...
  [*성과)*],
  [도메인 제약을 반영한 Augmentation 전략으로 모델 일반화 성능 개선, 우수상 수상],
  [*기술)*],
  [Python, PyTorch, ResNet, Transfer Learning, Image Classification],
)

== Organizations & Leadership

#block(spacing: 1.5em)[
  #block(below: 10pt, fill: gray1, inset: 6pt, radius: 3pt)[
    #text(fill: black1)[*블루칩뮤추얼펀드*, 교내 주식투자 동아리 -] #text(
      size: 0.9em,
      fill: black3,
    )[https://inhabluechip.com/]
    #h(1fr)
    #text(size: 0.9em, fill: black3)[2023.03 - 2024.08 (1년 6개월)]
  ]
  ...
  #block(above: 10pt, stroke: gray2, inset: (x: 8pt, y: 6pt), radius: 4pt)[
    1. *Seungjae Park*, "[특징주] ESR켄달스퀘어리츠(365550), 국내 최대 물류 전문 리츠…18개 센터 기초자산," Incheon Ilbo, Jan. 2024. #text(size: 0.8em, fill: black2)[https://www.incheonilbo.com/news/articleView.html?idxno=1230557]
    2. *Seungjae Park*, "[특징주] 한국항공우주(047810), 위성 넘어 우주로…하늘길 기술 역량 확장," Incheon Ilbo, Oct. 2023. #text(size: 0.8em, fill: black2)[https://www.incheonilbo.com/news/articleView.html?idxno=1216780]
    3. *Seungjae Park*, "2023년 1학기 세미나 8주차 - 시노펙스(박승재)," Youtube, May. 2024. #text(size: 0.8em, fill: black2)[https://youtu.be/R8GoPOt_Cmk]
    4. *Seungjae Park*, "2023년 2학기 세미나 한국항공우주(박승재)," Youtube, Oct. 2023. #text(size: 0.8em, fill: black2)[https://youtu.be/OLXZROdEfRc]
    5. *Seungjae Park*, "2024년 1학기 세미나 넥슨게임즈(박승재)," Youtube, Mar. 2024. #text(size: 0.8em, fill: black2)[https://youtu.be/nksrG1g1esE]
  ]
  - 활동 후반기에는 리서치 역량과 조직 기여도를 기반으로 리서치 팀장 및 펀드매니저로 선임되어 운용 및 조직 운영에 기여함
  #block(above: 10pt, stroke: gray2, inset: (x: 8pt, y: 6pt), radius: 4pt)[
    #block(below: 10pt)[#accent[*리서치 팀장 및 펀드매니저 #text(size: 0.9em, fill: black2)[(2024.01 - 2024.06)]*]]
...
#block(spacing: 1.5em)[
  #block(below: 10pt, fill: gray1, inset: 6pt, radius: 3pt)[
    #text(fill: black1)[*인트아이*, 학과 프로그래밍 소모임 -] #text(size: 0.9em, fill: black3)[https://int-i.github.io/]
    #h(1fr)
    #text(size: 0.9em, fill: black3)[2019.03 - 2024.08 (5년 6개월)]
  ]
  ...
  #block(above: 10pt, stroke: gray2, inset: (x: 8pt, y: 6pt), radius: 4pt)[
    #block(below: 10pt)[#accent[*소모임 회장 #text(size: 0.9em, fill: black2)[(2023.07 - 2024.03)]*]]
...
#block(spacing: 1.5em)[
  #block(below: 10pt, fill: gray1, inset: 6pt, radius: 3pt)[
    #text(fill: black1)[*학과 학생회*]
    #h(1fr)
    #text(size: 0.9em, fill: black3)[2019.03 - 2020.12, 2022.09 - 2023.06 (2년 6개월, 군 휴학 기간 제외)]
  ]
